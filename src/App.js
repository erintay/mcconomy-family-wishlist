          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              >
                ...
                <span className="font-medium" style={{ color: "#092327" }}>
                  Welcome, {currentUser}!
                </span>
                <button
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-4 mb-8">
          {familyMembers.map((member) => (
            <button
              ...
              style={
                selectedMember?.id === member.id ? selectedCard : unselectedCard
              }
            >
          ...
          >
            ...
            {showAddForm && selectedMember.name === currentUser && (
              <div
                ...
                style={{ backgroundColor: "#F0F9F9", borderColor: "#90C2E7" }}
              >
            ...
            <div className="space-y-3">
                ...
                >
                  ...
                  <div className="flex items-center space-x-2 ml-4">
                    {selectedMember.name !== currentUser && (
                      <button
                        onClick={() =>
                          togglePurchased(selectedMember.id, item.id)
                        }
              ...
              {(!wishlists[selectedMember.id] ||
                wishlists[selectedMember.id].length === 0) && (
        ...
        {!selectedMember && (
          <div className="text-center py-12">
            ...
            <p style={{ color: "#0B5351" }}>
              Choose someone above to view their wishlist
            </p>
          </div>
        )}
      </div>
